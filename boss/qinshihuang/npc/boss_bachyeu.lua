...
function tbQinshihuangBoss:DeathLoseItem(tbLoseItem)
	...
	local szMsg = "<color=green>Bạch Yêu rơi vật phẩm:<color>\n";
	local tbList = {};
...
function tbQinshihuangBoss:OnDeath(pNpcKiller)
	...
	local szMsg = string.format("Tổ đội của <color=green>%s<color> tại <color=green>"..GetMapNameFormId(nMapId).."<color> đánh gục Bạch Yêu!!!", pPlayer.szName);
GlobalExcute({"Dialog:GlobalNewsMsg_GS","<color=red>[Anh Hùng] <color><color=yellow><color=Turquoise>"..pPlayer.szName.."<color>: hạ gục Bạch Yêu nhận được <color=cyan>30tr Kinh Nghiệm, 2 [Triệu Tập] Bé Bánh Bao, 10 Thánh Linh Bảo Hạp Hồn , 10 Chân Nguyên Tu Luyện Đơn<color>"});
	KDialog.NewsMsg(1, Env.NEWSMSG_COUNT,"<color=red>[Anh Hùng] <color><color=yellow><color=Turquoise>"..pPlayer.szName.."<color>: hạ gục Bạch Yêu nhận được <color=cyan>30tr Kinh Nghiệm, 2 [Triệu Tập] Bé Bánh Bao, 10 Thánh Linh Bảo Hạp Hồn , 10 Chân Nguyên Tu Luyện Đơn<color>");
	KDialog.MsgToGlobal("<color=red>[Anh Hùng]<color> <color=yellow><color=Turquoise>"..pPlayer.szName.."<color>: hạ gục Bạch Yêu nhận được <color=cyan>30tr Kinh Nghiệm, 2 [Triệu Tập] Bé Bánh Bao, 10 Thánh Linh Bảo Hạp Hồn , 10 Chân Nguyên Tu Luyện Đơn<color>");	
	KDialog.NewsMsg(0, Env.NEWSMSG_COUNT, szMsg);
	self:BroadCast(szMsg);
	local nNpcMapId, nNpcPosX, nNpcPosY = him.GetWorldPos();
	pPlayer.AddExp(30000000) -- 30tr EXP
	pPlayer.AddStackItem(18,1,2092,1,nil,1) -- 1 [Triệu Tập] Bé Bánh Bao
	pPlayer.AddStackItem(18,1,1334,1,nil,10) -- 10 Thánh Linh Bảo Hạp Hồn
	pPlayer.AddStackItem(18,1,402,1,nil,10) -- 10 Chân Nguyên Tu Luyện Đơn
