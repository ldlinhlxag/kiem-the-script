...
local szMsg = string.format("Tổ đội của <color=green>%s<color> tại <color=green>"..GetMapNameFormId(nMapId).."<color> hạ gục Hắc Kỳ Lân!!!", pPlayer.szName);
GlobalExcute({"Dialog:GlobalNewsMsg_GS","<color=red>[Anh Hùng] <color><color=yellow><color=Turquoise>"..pPlayer.szName.."<color>: hạ gục Hắc Kỳ Lân nhận được <color=cyan>200tr Kinh Nghiệm, 20 Thánh Linh Bảo Hạp Hồn , 10 Chân Nguyên Tu Luyện Đơn<color>"});
	KDialog.NewsMsg(1, Env.NEWSMSG_COUNT,"<color=red>[Anh Hùng] <color><color=yellow><color=Turquoise>"..pPlayer.szName.."<color>: hạ gục Hắc Kỳ Lân nhận được <color=cyan>200tr Kinh Nghiệm, 20 Thánh Linh Bảo Hạp Hồn , 10 Chân Nguyên Tu Luyện Đơn<color>");
	KDialog.MsgToGlobal("<color=red>[Anh Hùng]<color> <color=yellow><color=Turquoise>"..pPlayer.szName.."<color>: hạ gục Hắc Kỳ Lân nhận được <color=cyan>200tr Kinh Nghiệm, 20 Thánh Linh Bảo Hạp Hồn , 10 Chân Nguyên Tu Luyện Đơn<color>");	
	KDialog.NewsMsg(0, Env.NEWSMSG_COUNT, szMsg);
	self:BroadCast(szMsg);
		local nNpcMapId, nNpcPosX, nNpcPosY = him.GetWorldPos();
	pPlayer.AddExp(200000000) -- 200tr EXP
	pPlayer.AddStackItem(18,1,1334,1,nil,20) -- 20 Thánh Linh Bảo Hạp Hồn
