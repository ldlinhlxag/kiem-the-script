...
function tbQinshihuangBoss:OnDeath(pNpcKiller)
	...
	pPlayer.AddItem(18,1,676,1); -- vi du HT 10
	pPlayer.AddItem(18,1,25160,6); -- vi du HT 10
	pPlayer.AddItem(18,1,25160,7); -- vi du HT 10
	pPlayer.AddItem(18,1,1,10); -- vi du HT 10
