local tbItem = Item:GetClass("item_bebanhbao2");
function tbItem:OnUse()
DoScript("\\script\\event\\cacevent\\tetthieunhi\\item_bebanhbao2.lua") -- Reload Siro Ngũ Sắc
local tbEvent = 
{
...
local pNpc = KNpc.Add2(9652, 1, 0, nMapId, nPosX, nPosY)
