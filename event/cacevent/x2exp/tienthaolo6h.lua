...
local tbItem = Item:GetClass("tienthaolo6h");
...
tbItem.tbEffect = {   
 [1] = 6;--(Thời gian hiệu nghiệm của thẻ.Đơn vị tính bằng Giờ)
}
...
KDialog.MsgToGlobal("<color=yellow>Người chơi <color=green>["..me.szName.."]<color> sử dụng <color=green>Tiên Thảo Lộ (6 giờ)<color> nhận được <color=cyan>6 Giờ x2 Kinh Nghiệm<color><color>");	   
