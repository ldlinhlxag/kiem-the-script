...
local tbItem = Item:GetClass("tienthaolo3h");
...
tbItem.tbEffect = {   
 [1] = 3;--(Thời gian hiệu nghiệm của thẻ.Đơn vị tính bằng Giờ)
}
...
KDialog.MsgToGlobal("<color=yellow>Người chơi <color=green>["..me.szName.."]<color> sử dụng <color=green>Tiên Thảo Lộ (3 giờ)<color> nhận được <color=cyan>3 Giờ x2 Kinh Nghiệm<color><color>");	   
