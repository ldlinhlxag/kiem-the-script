local tbBaoLuong = Npc:GetClass("sltk_tuiquanluong");
tbBaoLuong.tbItemInfo = {bForceBind=1,};
function tbBaoLuong:OnDialog()
DoScript("\\script\\event\\cacevent\\cuopluongthao\\baoluong.lua");
	local tbEvent = 
	{
...
function tbBaoLuong:GetQuest(nPlayerId, nNpcId)
