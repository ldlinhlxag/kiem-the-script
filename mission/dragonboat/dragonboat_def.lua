...
DragonBoat.PRODUCT_SKILL = {
	...
	--攻击性
	[1] = {
		{1363, "Lữ băng", "Khiến mục tiêu chậm 5 giây, đánh định điểm.",{[1]=1,[2]=1,[3]=1,[4]=1}, 15000},
		{1364, "Ám tiêu", "Khiến mục tiêu choáng 2 giây, đánh định điểm.",{[1]=1,[2]=1,[3]=1,[4]=1}, 15000},
		{1365, "Hiên lãng", "Khiến mục tiêu bất động 3 giây, đánh định điểm.",{[1]=1,[2]=1,[3]=1,[4]=1}, 15000},
		{1366, "Xoáy nước", "Làm mục tiêu hỗn loạn 2 giây, đánh định điểm.",{[1]=1,[2]=1,[3]=1,[4]=1}, 15000},
	},
	
	[2] = {
		{1372, "Thạch phu", "Bị bất động và hiệu quả giảm tốc -40%",{[1]=1,[2]=1,[3]=1,[4]=1}, 15000},
		{1373, "Long tâm", "Bị hỗn loạn và hiệu quả giảm tốc -40%",{[1]=1,[2]=1,[3]=1,[4]=1}, 15000},
		{1374, "Hải hồn", "Bị choáng và hiệu quả giảm tốc -40%",{[1]=1,[2]=1,[3]=1,[4]=1}, 15000},
		{1375, "Nghịch lân", "Hiệu quả tất cả trạng thái bất lợi -30%",{[4]=1}, 30000},
	},
};
...
DragonBoat.MIS_UI 	= 
{
	[1] = {"<color=green>Thời gian bắt đầu còn: <color=white>%s<color>"};
	[2] = {"<color=green>Thời gian thi đấu còn: <color=white>%s<color>"};
};
