...
function tbZhanQi:GiveTheFlagToPlayer(nCampId, tbBattleInfo)
	...
	local szFirMsg	= string.format("<color=red>%s<color> quân %s <color=green>%s<color> hộ tống Chiến Kỳ tiến về (%d, %d)", Battle.NAME_CAMP[tbBattleInfo.tbCamp.nCampId], Battle.NAME_RANK[tbBattleInfo.nRank], tbBattleInfo.pPlayer.szName, tbFlagDesPos[2] / 8, tbFlagDesPos[3] / 16);	
