...
-- NPC刷点表 
XoyoGame.NPC_POINT_PATH_LV1 	= "\\setting\\xoyogame\\npc_pos_lv1.txt";
XoyoGame.NPC_POINT_PATH_LV2 	= "\\setting\\xoyogame\\npc_pos_lv2.txt";
XoyoGame.NPC_POINT_PATH_LV3 	= "\\setting\\xoyogame\\npc_pos_lv3.txt";
XoyoGame.NPC_POINT_PATH_LV4 	= "\\setting\\xoyogame\\npc_pos_lv4.txt";
XoyoGame.NPC_POINT_PATH_LV5 	= "\\setting\\xoyogame\\npc_pos_lv5.txt";
-- NPC移动路线
XoyoGame.NPC_ROAD_PATH 			= "\\setting\\xoyogame\\npc_road.txt";
-- 题库
XoyoGame.GUESS_PATH				= "\\setting\\xoyogame\\xoyo_question.txt";
-- 房间权限 
XoyoGame.ROOM_WEIGHT			= "\\setting\\xoyogame\\room_weight.txt";
