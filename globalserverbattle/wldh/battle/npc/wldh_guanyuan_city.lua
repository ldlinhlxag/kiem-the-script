...
function tbNpc:GetServerAward(nSure)
	...
	-- 3.幸运时间
	me.AddSkillState(880, tbAward.Xingyun, 2, 30 * 60 * Env.GAME_FPS, 1, 0, 1);
	
	-- 4.经验时间
	me.AddSkillState(879, tbAward.Exp, 2, 60 * 60 * Env.GAME_FPS, 1, 0, 1);
	
	-- 5.磨刀护甲五行
	if tbAward.Level > 0 then
		me.AddSkillState(385, tbAward.Level, 2, 60 * 60 * Env.GAME_FPS, 1, 0, 1);
		me.AddSkillState(386, tbAward.Level, 2, 60 * 60 * Env.GAME_FPS, 1, 0, 1);
		me.AddSkillState(387, tbAward.Level, 2, 60 * 60 * Env.GAME_FPS, 1, 0, 1);
	end
