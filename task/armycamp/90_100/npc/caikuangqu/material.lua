...
function tbNpc:OnDialog()
	...
	GeneralProcess:StartProcess("Đang thu thập..", 15 * 18, {self.OnCollect, self, him.dwId, me.nId}, {me.Msg, "Thu thập thất bại.."}, tbEvent);		
end;
...
function tbNpc:OnCollect(nNpcId, nPlayerId)
	...
	-- TODO:liuchang 之後得注冊FB計時器，當FB關閉的時候會關閉這些計時器
