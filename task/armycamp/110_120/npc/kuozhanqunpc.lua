...
function tbMiDao:OnDialog()
	Dialog:Say("Bạn đã chuẩn bị đầy đủ rồi chứ", 
			{
				{"Hãy đưa ta đi", self.Enter, self, him.dwId, me.nId},
				{"Kết thúc đối thoại"},
			}
		);	
end;
...
tbQiHun.szDesc	= "棋魂";
tbQiHun.szText 	= "棋盤變化，奧妙無窮，世間萬物，包羅其中，來來來，我們下盤棋。";
...
tbYingHun.szDesc	= "影魂";
tbYingHun.szText 	= "也許世界上最難的事情，就是戰勝自己，你做好准備了嗎？";
tbYingHun.tbCapyNpc	= {
		[1] = 4251,
		[2] = 4252,
...
function tbYingHun:OnDialog()
	Dialog:Say(self.szText, 
			{
				{"開始戰斗", self.FightStart, self, him.dwId, me.nId},
				{"Kết thúc đối thoại"},
			}
		);
end;
...
tbLiuYiBan_Dialog.szText = "<npc=4276>：怎麼是你，怎麼還是你？我閃先。"
