...
_GEN_AFFAIR_RECORD_FUN("StorageFundToKin",	22, 3, '<color=green>%s<color> chuyển quỹ bang hội vào gia tộc <color=green>%s<color> <color=yellow>%s<color> lượng');
_GEN_AFFAIR_RECORD_FUN("GetFundFromKin",23, 2, 'Gia tộc <color=green>%s<color> chuyển <color=yellow>%s<color> lượng quỹ gia tộc vào bang hội.');
