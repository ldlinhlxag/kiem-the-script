...
_GEN_TASK_FUN("TotalRepute", 6)			--Gia tộc总威望
_GEN_TASK_FUN("VoteCounter", 7)			--Gia tộc投票流水号
_GEN_TASK_FUN("VoteStartTime", 8)		--Gia tộc投票启始时间
...
_GEN_TASK_FUN("GainExpState", 18) 		--Gia tộc领取令牌的状态
_GEN_TASK_FUN_U("TogetherTime", 19)		-- Gia tộc聚集时间,最近一次Gia tộc插旗的时间
_GEN_TASK_FUN_U("ChangeCampDate", 20) 	-- 最近改变阵营的日期（距离1970年1月1日的天数）
_GEN_TASK_FUN_U("KinGameTime", 21)		-- 最近一次开启Gia tộc关卡的时间
_GEN_TASK_FUN_U("KinGameDegree", 22)	-- 进入Gia tộc关卡的次数
_GEN_TASK_FUN("KinGuYinBi", 23)			-- Gia tộc古银币数量

-- Gia tộc插旗时间的变量
_GEN_TASK_FUN_U("KinBuildFlagOrderTime", 24) 	-- Gia tộc插旗设置的时间
_GEN_TASK_FUN_U("KinBuildFlagMapId", 25) 		-- Gia tộc插旗设置的地点的地图名字
_GEN_TASK_FUN_U("KinBuildFlagMapX", 26) 		-- Gia tộc插旗设置的地点的地图X坐标
_GEN_TASK_FUN_U("KinBuildFlagMapY", 27) 		-- Gia tộc插旗设置的地点的地图Y坐标

-- Gia tộc周活动相关变量
_GEN_TASK_FUN_U("KinOffer", 28)			-- Gia tộc贡献度
_GEN_TASK_FUN_U("WeeklyTask", 29)		-- Gia tộc周目标
_GEN_TASK_FUN_U("WeeklyKinOffer", 30)	-- 本周Gia tộc贡献度
_GEN_TASK_FUN_U("LastWeekKinOffer", 31)	-- 上周的Gia tộc贡献度
_GEN_TASK_FUN_U("JoinTongTime", 32)		-- 加入帮会时间
--_GEN_TASK_FUN_U("TongOffer", 33)		-- Gia tộc对帮会的总贡献 已无效
_GEN_TASK_FUN("LastWeeklyTask", 34)	-- 上周的Gia tộc活动
...
-- Gia tộc招募的变量
_GEN_TASK_FUN("RecruitmentPublish", 39)	-- Gia tộc招募是否发布
_GEN_TASK_FUN("RecruitmentLevel", 40)	-- Gia tộc招募等级限制
_GEN_TASK_FUN("RecruitmentHonour", 41)	-- Gia tộc招募荣誉等级限制
_GEN_TASK_FUN("RecruitmentPublishTime", 42)	-- Gia tộc招募发布时间

-- Gia tộc关卡活动的变量
--_GEN_TASK_FUN_U("KinGameOrderTime1", 208) 	-- Gia tộc关卡设置的时间1
--_GEN_TASK_FUN_U("KinGameOrderTime2", 209) 	-- Gia tộc关卡设置的时间2
--_GEN_TASK_FUN_U("KinGameOrderTime3", 210) 	-- Gia tộc关卡设置的时间3
--_GEN_TASK_FUN("KinGameOrderMapId", 211) 		-- Gia tộc关卡设置的地点的地图名字
...
_GEN_TASK_FUN_U("PlatformScore", 205)	-- 活动平台记录每月Gia tộc竞技平台积分
_GEN_TASK_FUN_U("PlatformKinAward", 206)	-- 活动平台记录每月Gia tộc竞技平台成员奖励标记
_GEN_TASK_FUN_U("PlatformAwardCount", 207)	-- 活动平台记录每月Gia tộc竞技平台成员奖励领取成员数
_GEN_TASK_FUN_U("PlatformKinRank", 208)	-- 活动平台Gia tộc排名
...
_GEN_BUF_TASK_FUN("Name", 1)				 --Gia tộc名称
...
_GEN_BUF_TASK_FUN("Announce", 7)			--Gia tộc公告

_GEN_HISTORY_RECORD_FUN("Establish", 	1, 7, 'Gia tộc "%s" thiếp lập tộc trưởng: "%s", các thành viên: %s %s %s %s %s');
_GEN_HISTORY_RECORD_FUN("Split", 		2, 1, 'Gia tộc "%s" từ rời khỏi');
_GEN_HISTORY_RECORD_FUN("Compose", 		3, 1, 'Gia tộc "%s" được thành lập');
_GEN_HISTORY_RECORD_FUN("PlayerJoin", 	4, 1, 'Người chơi "%s" gia nhập Gia tộc');
_GEN_HISTORY_RECORD_FUN("JoinTong", 	5, 1, 'Gia tộc vào bang "%s"');
_GEN_HISTORY_RECORD_FUN("LeaveTong", 	6, 1, 'Gia tộc rời bang "%s"');

_GEN_AFFAIR_RECORD_FUN("ChangeCaptain",	7, 2, 'Người chơi "%s" thay Người chơi "%s" thành tộc trưởng.');
