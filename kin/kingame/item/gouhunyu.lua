...
function tbLingPai:OnUse()
	...
	GeneralProcess:StartProcess("召唤中...", 5 * Env.GAME_FPS, {self.EndProcess, self, it.dwId, nMapId}, nil, tbEvent);
	return 0;
end
...
function tbLingPai:EndProcess(nItemId, nMapId)
	...
	Timer:Register(self.CALLTIME * Env.GAME_FPS, self.CallKinBoss, self, nKinId, nItemLevel, nMapId)
