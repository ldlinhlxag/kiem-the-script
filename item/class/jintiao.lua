...
function tbItem:SureUse(pItem, nType, nSure)
	...
	if self.ExReturnBindMoney > 0 then
		...
		KStatLog.ModifyAdd("bindjxb", "[产出]金条开出", "Tổng", math.floor(self.ExReturnBindMoney * nGetBindMoney / 100));	
	end
