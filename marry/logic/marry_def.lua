...
Marry.PERFORM_STEP = 
{
	[1] = "<color=orange>Mời cô dâu, chú rể bắt đầu Điển lễ<color>",
	[2] = "<color=orange>Điển lễ mở ra, đợi quý khách<color>",
	[3] = "<color=orange>quý khách tới chơi, đợi bái đường<color>",
	[4] = "<color=orange>bái đường, đợi yến hội<color>",
	[5] = "<color=orange>Yến hội, trò chơi, điển lễ kết thúc<color>",
}
...
function Marry:CheckAddWedding(nWeddingLevel, nDate)
	...
	elseif nWeddingLevel == 4 then
		...
		local nTime = GetTime(); --Lib:GetDate2Time(nDate); 
		...
		for i = 1, 7 do
			...
			local nTmpDate = tonumber(os.date("%d%m%Y", nTime + nTmpDay *24*3600 - tbTime.wday *24*3600));
