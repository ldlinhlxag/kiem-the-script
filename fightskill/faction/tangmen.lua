...
local tb	= {
	ducigu={ --毒刺骨_20
		...
		skill_mintimepercast_v={{{1,2.5*18},{20,2.5*18},{21,2.5*18},{30,2.5*18},{40,2.5*18}}},
	...
	miyingzong={ --迷影纵_10
		...
		skill_mintimepercast_v={{{1,8*18},{10,5*18},{11,5*18},{20,5*18},{30,5*18}}},
		skill_mintimepercastonhorse_v={{{1,11*18},{10,8*18},{11,8*18},{20,5*18},{30,5*18}}},
	},
	xixingzhen={ --吸星阵
		...
		skill_mintimepercast_v={{{1,2.5*18},{10,2.5*18},{11,2.5*18},{20,2.5*18},{30,2.5*18}}},
	...
	xianjingadvancedbook={ --高级秘籍_10
		...
		skill_mintimepercast_v={{{1,60*18},{10,15*18},{20,15*18},{30,15*18}}},
		skill_mintimepercastonhorse_v={{{1,60*18},{10,15*18},{20,15*18},{30,15*18}}},
	...
	xiujian120={ --袖箭120_10
		...
		skill_mintimepercast_v={{{1,18*6},{10,18*6},{20,18*6},{30,18*6}}},
		skill_mintimepercastonhorse_v={{{1,18*6},{10,18*6},{20,18*6},{30,18*6}}},
