...
-------------- 定义特定地图回调 ---------------
local tbTest = Map:GetClass(17); -- 地图Id
...
tbTest:GetTrapClass("to_bingqipu").OnPlayer	= function (self)
	me.NewWorld(154,1605,3230)	-- 传送,[地图Id,坐标X,坐标Y]	
end;

tbTest:GetTrapClass("to_fangjupu").OnPlayer	= function (self)
	me.NewWorld(154,1728,3235)	-- 传送,[地图Id,坐标X,坐标Y]	
end;

tbTest:GetTrapClass("to_yaodian").OnPlayer	= function (self)
	me.NewWorld(154,1842,3230)	-- 传送,[地图Id,坐标X,坐标Y]	
end;

tbTest:GetTrapClass("to_zahuodian").OnPlayer	= function (self)
	me.NewWorld(154,1948,3229)	-- 传送,[地图Id,坐标X,坐标Y]	
end;
