...
-------------- 定义特定地图回调 ---------------
local tbTest = Map:GetClass(159); -- 地图Id
...
tbTest:GetTrapClass("to_exit1").OnPlayer	= function (self)
	me.NewWorld(22,1732,3298)	-- 传送,[地图Id,坐标X,坐标Y]	
end;

tbTest:GetTrapClass("to_exit2").OnPlayer	= function (self)
	me.NewWorld(22,1751,3320)	-- 传送,[地图Id,坐标X,坐标Y]	
end;

tbTest:GetTrapClass("to_exit3").OnPlayer	= function (self)
	me.NewWorld(22,1835,3411)	-- 传送,[地图Id,坐标X,坐标Y]	
end;

tbTest:GetTrapClass("to_exit4").OnPlayer	= function (self)
	me.NewWorld(22,1851,3426)	-- 传送,[地图Id,坐标X,坐标Y]	
end;
