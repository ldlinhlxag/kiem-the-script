...
local tbNpc = Npc:GetClass("defendnpc_shibing");
...
function tbNpc:OnDeath(pKiller)
	...
	Domain.tbGame[nMapId]:AddPlayerScore(pPlayer, Domain.SCORE_SHIBING, math.floor(Domain.SCORE_SHIBING * nRate), " đẩy lùi "..him.szName);
